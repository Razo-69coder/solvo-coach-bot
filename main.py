...
async def get_me(trainer_id: int = get_current_trainer_id):  # type: ignore
    trainer = await get_trainer_by_id(trainer_id)
    if not trainer:
...
async def update_settings(body: TrainerSettingsRequest, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def get_my_stats(trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def list_clients(
    page: int = Query(0),
    search: str = Query(""),
    trainer_id: int = get_current_trainer_id,  # type: ignore
):
    if search:
...
async def create_client_endpoint(body: ClientCreateRequest, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def get_client_detail(client_id: int, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def update_client_endpoint(client_id: int, body: ClientUpdateRequest, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def delete_client_endpoint(client_id: int, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def get_schedule_endpoint(date: str = Query(...), trainer_id: int = get_current_trainer_id):  # type: ignore
    sessions = await get_schedule(trainer_id, date)
    return {"date": date, "sessions": sessions}


@app.get("/api/v1/slots")
async def get_slots_endpoint(date: str = Query(...), trainer_id: int = get_current_trainer_id):  # type: ignore
    trainer = await get_trainer_by_id(trainer_id)
    if not trainer:
        raise HTTPException(404, "Тренер не найден")
...
async def create_session_endpoint(body: SessionCreateRequest, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def cancel_session(session_id: int, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def complete_session_endpoint(session_id: int, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def create_subscription_endpoint(body: SubscriptionCreateRequest, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def deactivate_subscription_endpoint(sub_id: int, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def create_payment_endpoint(body: PaymentCreateRequest, trainer_id: int = get_current_trainer_id):  # type: ignore
...
async def mark_paid(payment_id: int, trainer_id: int = get_current_trainer_id):  # type: ignore
